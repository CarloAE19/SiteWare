...
elseif (in_array($action, ['fetch_supplier_delivery_history', 'fetch_po_items', 'fetch_po_details', 'create_po', 'mark_po_out_for_delivery', 'upload_po_receipt', 'mark_po_delivered', 'cancel_po', 'log_po_delay', 'update_po_eta'])) {
