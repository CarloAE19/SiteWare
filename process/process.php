...
$is_ajax = (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest') ||
    ...
    (in_array($action, ['live_sync', 'stock_in_scanned', 'verify_current_password', 'change_password_modal', 'unlock_screen', 'lock_screen', 'ping_session', 'update_idle_settings', 'submit_audit', 'create_backup', 'restore_backup', 'delete_backup', 'fetch_backups', 'create_rs', 'edit_rs', 'approve_rs', 'reject_rs', 'stage_rs_materials', 'create_withdrawal']));
