...
if ($action === 'fetch_combined_alerts') {
    ...
    // 1. Fetch Supply ETA Alerts from Purchase Orders (Authorized procurement and warehouse roles only)
    if (in_array($userRole, ['admin', 'management', 'purchasing', 'warehouse'])) {
        $poQuery = "
